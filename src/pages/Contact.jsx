...
export default function Contact() {
  // Removed useState, handleSubmit, and handleChange as Netlify will handle the form
    ...
    <div className="bg-white pt-32 pb-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-16 grid max-w-7xl grid-cols-1 gap-x-8 gap-y-16 lg:grid-cols-2">
          ...
          {/* Configured form for Netlify */}
          <form name="contact" method="POST" data-netlify="true" className="mx-auto w-full max-w-xl lg:mx-0 lg:pr-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input type="text" name="name" id="name" required className="mt-1 block w-full rounded-md border-primary/50 py-3 shadow-sm focus:border-primary focus:ring-primary sm:text-sm" /> {/* Removed value and onChange */}
              </div>
              ...
              <div>
                ...
                <input type="email" name="email" id="email" required className="mt-1 block w-full rounded-md border-primary/50 py-3 shadow-sm focus:border-primary focus:ring-primary sm:text-sm" /> {/* Removed value and onChange */}
              </div>
              ...
              <div>
                ...
                <input type="tel" name="phone" id="phone" required className="mt-1 block w-full rounded-md border-primary/50 py-3 shadow-sm focus:border-primary focus:ring-primary sm:text-sm" /> {/* Removed value and onChange */}
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  required
                  className="mt-1 block w-full rounded-md border-primary/50 py-3 shadow-sm focus:border-primary focus:ring-primary sm:text-sm" // Changed border
                >
                ...
                <div className="mt-2 space-y-2">
                  <div className="relative flex items-start">
                    <div className="flex h-6 items-center">
                      <input id="service-adult" name="serviceRequested[]" type="checkbox" value="Adult Assessment" className="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary" /> {/* Changed name, removed onChange */}
                    </div>
                   ...
                   <div className="relative flex items-start">
                    <div className="flex h-6 items-center">
                      <input id="service-child" name="serviceRequested[]" type="checkbox" value="Child Assessment" className="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary" /> {/* Changed name, removed onChange */}
                    </div>
                    <div className="ml-3 text-sm leading-6">
                   ...
                   <div className="relative flex items-start">
                    <div className="flex h-6 items-center">
                      <input id="service-both" name="serviceRequested[]" type="checkbox" value="Both" className="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary" /> {/* Changed name, removed onChange */}
                    </div>
                    <div className="ml-3 text-sm leading-6">
                 ...
                 {/* Removed checkbox validation logic */}
              </fieldset>
              ...
              <div>
                ...
                <input type="text" name="insurance" id="insurance" required placeholder="e.g., RMHP Medicaid, Out-of-Network, Private Pay" className="mt-1 block w-full rounded-md border-primary/50 py-3 shadow-sm focus:border-primary focus:ring-primary sm:text-sm" /> {/* Removed value and onChange */}
              </div>
              ...
              <div>
                ...
                <textarea name="reason" id="reason" rows={3} required className="mt-1 block w-full rounded-md border-primary/50 py-3 shadow-sm focus:border-primary focus:ring-primary sm:text-sm" /> {/* Removed value and onChange */}
              </div>
              ...
              <div>
                ...
                <textarea name="message" id="message" rows={4} className="mt-1 block w-full rounded-md border-primary/50 py-3 shadow-sm focus:border-primary focus:ring-primary sm:text-sm" /> {/* Removed value and onChange */}
              </div>
            </div>
          ...
          <div className="mx-auto w-full max-w-xl lg:mx-0 lg:pl-8 lg:border-l lg:border-gray-200"> {/* Added padding-left and border on large screens */}
            {/* ... (Keep existing contact info blocks: Location, Phone, Email) ... */}
                ...
                <div>
                  ...
                  <div className="mt-4 flex gap-x-4">
                    <a
                      ...
                      className="inline-flex items-center justify-center gap-x-2 rounded-md bg-accent px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-accent/80" /* Added gap */
                    >
                      {/* Google Maps Image */}
                      <img src="/googlemaps.png" alt="Google Maps icon" className="h-4 w-auto" /> {/* Using img tag */}
                      Google Maps
                    </a>
                    <a
                    ...
                    >
                       {/* Apple Maps Image */}
                       <img src="/applemaps.png" alt="Apple Maps icon" className="h-4 w-auto" /> {/* Using img tag */}
                      Apple Maps
                    </a>
                  </div>
