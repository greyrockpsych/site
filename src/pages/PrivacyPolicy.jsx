...
export default function PrivacyPolicy() {
  return (
    ...
    <div className="bg-white pt-32 pb-24">
      <div className="mx-auto max-w-3xl px-6 lg:px-8"> {/* Using max-w-3xl for readability */}
        <h1 className="text-3xl font-bold tracking-tight text-primary sm:text-4xl mb-8 text-center">
          Privacy Policy
        </h1>
        ...
        <div className="prose prose-neutral max-w-none"> {/* Using prose for basic markdown styling */}
          ...
          <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">Information Collected</h2>
          <p>
          ...
          <ul>
            <li>A name and an email address so we can notify you about scheduling or send requested information – you would be affirmatively consenting to this by providing this to us in our contact forms.</li>
            <li>Billing information, including name, address, and credit card information, so that we can process payment to deliver our services to you under our contractual obligation.</li>
            <li>A name and an email address if you complete our contact form with a question.</li>
          </ul>
          <p>
          ...
          <h3 className="text-xl font-semibold text-primary mt-6 mb-3">Retention and Deletion</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-primary mt-6 mb-3">Sensitive Information</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-primary mt-6 mb-3">Anonymous Data Collection and Use</h3>
          <p>
          ...
          <ul>
            <li><span className="font-semibold">Internet Protocol (IP) Address</span> — Your IP address is a number that lets computers attached to the Internet know where to send you data — such as the web pages you view. We use this information to deliver our web pages to you upon request and to measure traffic within our Sites.</li>
            <li><span className="font-semibold">Cookies</span> — Our sites use “cookies” to improve functionality and usability. We use this information for planning, tracking, and improving the technical functions of our Sites. By using our products and agreeing to this Policy, you consent to our use of cookies in accordance with the terms of this Policy.</li>
          </ul>

          <h3 className="text-xl font-semibold text-primary mt-6 mb-3">About Cookies</h3>
          <p>
          ...
          <h4 className="text-lg font-semibold text-primary mt-4 mb-2">Blocking cookies</h4>
          <p>
            Most browsers allow users to refuse to accept cookies.
          </p>
          <ul>
            <li>In Google Chrome, you can adjust your cookie permissions by clicking “Options,” “Under the hood,” and Content Settings in the “Privacy” section. Click on the Cookies tab in the Content Settings.</li>
          ...
          <h4 className="text-lg font-semibold text-primary mt-4 mb-2">Deleting cookies</h4>
          <p>
            Users can also delete cookies already stored on their computers:
          </p>
          <ul>
            <li>In Google Chrome, you can adjust your cookie permissions by clicking “Options,” “Under the hood,” and Content Settings in the “Privacy” section. Click on the Cookies tab in the Content Settings.</li>
            <li>In Safari, you can delete cookies by clicking “Preferences,” selecting the “Privacy” tab, and selecting “Remove All Website Data.”</li>
          ...
          <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">Use of Information Collected Via the Sites</h2>
          ...
          <ul>
            <li>To deliver services, such as information or newsletters you request or purchase;</li>
            <li>To let you know about updated information and other new services from GPS LLP</li>
            <li>To ensure the Sites are relevant to your needs;</li>
            <li>To help us create and publish content most relevant to you;</li>
            <li>To request your feedback about your experience with GPS LLP;</li>
            <li>To notify you about a material change to this Policy, if necessary; and</li>
            <li>To allow you access to limited-entry areas of the Sites.</li>
          </ul>
          ...
          <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">Release of Information to Third Parties</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">Third Party Websites and Advertisers</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">Opt-Out</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">Changes in Our Privacy Policy</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">Website Security</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">Assignment</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">What We Do With Information We Collect</h2>

          <h3 className="text-xl font-semibold text-primary mt-6 mb-3">Contact You</h3>
          <p>
            We may contact you with information that you provide to us based on these lawful grounds for processing:
          </p>
          <ul>
            <li><span className="font-semibold">Consent.</span> We may contact you if you give us your clear, unambiguous, affirmative consent to contact you.</li>
            <li><span className="font-semibold">Contract.</span> We will contact you under our contractual obligation to deliver goods or services you purchase from us.</li>
            <li><span className="font-semibold">Legitimate Interest.</span> We may contact you if we feel you have a legitimate interest in hearing from us. For example, if you sign up for a webinar, we may send you marketing emails based on the content of that webinar. You will always have the option to opt out of any of our emails.</li>
          </ul>

          <h3 className="text-xl font-semibold text-primary mt-6 mb-3">Process Payments</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-primary mt-6 mb-3">Share with Third Parties</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-primary mt-6 mb-3">Viewing by Others</h3>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">Submission, Storage, Sharing, and Transferring of Personal Data</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">Data Retention</h2>
          <p>
            We retain your Personal Data for the minimum amount of time necessary to provide you with the information and/or services that you requested from us. We may include certain Personal Data for longer periods of time if necessary for legal, contractual, and accounting obligations.
          </p>

          <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">Confidentiality</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">Passwords</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">How You Can Access, Update, or Delete Your Personal Data</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">Anti-Spam Policy</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">Third Party Websites</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">Children’s Online Privacy Protection Act Compliance</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">Notification of Changes</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">Data Controller and Processors</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">Contacting Greyrock Psychological Services</h2>
          <p>
            You may contact us by mail at 2627 Redwing Road, Suite #130, Fort Collins, CO, 80526 with any questions. Email any questions or concerns regarding this Privacy Policy to contact@greyrockpsych.com. Please allow at least two business days for responses to outreach.
          </p>
